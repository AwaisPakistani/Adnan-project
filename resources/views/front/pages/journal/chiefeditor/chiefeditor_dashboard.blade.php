...
<div class="container mb-3 mt-3">
    <div class="row">
       <div class="col-lg-12 text-center">
            ...
            <a href="#" class="btn" style="background-color:{{$advancesetting->button_color}}; color:white;" type="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="multiCollapseExample2">Journal Volumes</a>
